...
public class EmployeeDAO {
    ...
    public ArrayList<HashMap> listEmployee() {
        ArrayList<HashMap> emp_list = null;
        if (conn == null) {
            ...
            String sql = "SELECT username, passwd, email,type, create_dated FROM " + table + ";";
            ...
            try {
                ...
                ArrayList<HashMap<Integer, String>> checkList = new ArrayList<>();
...
//            hashMap.put("total", Integer.parseInt(String.valueOf(order.get("quantity"))) * Integer.parseInt(String.valueOf(data.get("price"))));
                ...
                System.err.print("Emp Query error: " + e);
            }
        }
        return emp_list;
    }
